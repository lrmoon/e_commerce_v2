...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            profile.profile_picture = 'images/avatars/default_avatar.jpeg'
            profile.save()
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    #get the cart_items from the user to access his product variations
...
def forgotPassword(request):
    if request.method == 'POST':
        ...
        if Account.objects.filter(email=email).exists():
            ...
            messages.success(request, 'The link to reset your password has been sent to your email address.')
            return redirect('login')
        else:
